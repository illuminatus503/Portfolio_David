...
const en = {
  ...
  education: {
    ...
    master: 'Master in Artificial Intelligence',
  ...
  skills: {
    ...
    python: {
      ...
      details: 'Django, Flask, FastAPI, Data Analysis, Machine Learning'
    },
    ada: {
      name: 'Ada',
    ...
    java: {
      ...
      details: 'Spring Framework, Microservices, Enterprise applications'
    },
    cpp: {
      name: 'C/C++',
      description: 'High-performance computing',
      details: 'CUDA, MPI, Parallel programming, System programming'
    },
    sql: {
      name: 'SQL',
      description: 'Database management',
      details: 'PostgreSQL, MySQL, Database design, Query optimization'
    },
    cobol: {
      name: 'COBOL',
      description: 'Legacy systems',
      details: 'Mainframe applications, Business systems'
    },
    fortran: {
      name: 'Fortran',
      description: 'Scientific computing',
      details: 'Numerical analysis, High-performance computing'
    },
    tailwind: {
      name: 'Tailwind CSS',
