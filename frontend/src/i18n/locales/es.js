...
const es = {
  ...
  education: {
    ...
    university: 'UPV/EHU - Donostia-San Sebastián',
    master: 'Máster en Inteligencia Artificial',
    masterUniversity: 'UAX - Universidad Alfonso X',
  ...
  skills: {
    ...
    python: {
      name: 'Python',
      description: 'Desarrollo Backend & IA',
      details: 'Django, Flask, FastAPI, Análisis de Datos, Machine Learning'
    },
    ada: {
      name: 'Ada',
    ...
    java: {
      ...
      details: 'Spring Framework, Microservicios, Aplicaciones empresariales'
    },
    cpp: {
      name: 'C/C++',
      description: 'Computación de alto rendimiento',
      details: 'CUDA, MPI, Programación paralela, Programación de sistemas'
    },
    sql: {
      name: 'SQL',
      description: 'Gestión de bases de datos',
      details: 'PostgreSQL, MySQL, Diseño de bases de datos, Optimización de consultas'
    },
    cobol: {
      name: 'COBOL',
      description: 'Sistemas legacy',
      details: 'Aplicaciones mainframe, Sistemas empresariales'
    },
    fortran: {
      name: 'Fortran',
      description: 'Computación científica',
      details: 'Análisis numérico, Computación de alto rendimiento'
    },
    tailwind: {
      name: 'Tailwind CSS',
  ...
  contact: {
    ...
    email: 'Email *',
    location: 'Ubicación',
    locationValue: 'Düsseldorf, Alemania',
  ...
  footer: {
    ...
    madeWith: 'Hecho con ❤️ y ☕',
    social: 'Conecta conmigo'
  }
};
