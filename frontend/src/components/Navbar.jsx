        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            ...
            <a
              href="/admin"
              className={getThemeClasses(
                'px-3 py-1 rounded transition-colors duration-200 flex items-center space-x-2',
          ...
          <div className={getThemeClasses(
            ...
            <div className="flex flex-col space-y-2 pt-4">
              ...
              <a
                href="/admin"
                className={getThemeClasses(
                  'text-left py-2 transition-colors duration-200 hover:text-accent flex items-center space-x-2',
                  'text-textLight-dark',
                  'text-textLight-light'
                )}
              >
